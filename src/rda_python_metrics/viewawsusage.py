...
#      Date : 2025-08-13
#             2025-12-19 convert to class ViewAWSUsage
...
class ViewAWSUsage(PgView):
   ...
   def __init__(self):
      ...
      # SHRTNM COLUMNNAME   FIELDNAME                         CNDNAME       TBLNAM        Size Prc Grp/Sum
         ...
         'M' : ['MONTH',     self.fmtym("date"),              'date',       'awsusage',   7,   0,  'G'],
         ...
         'Y' : ['YEAR',      self.fmtyr("date"),              'date',       'awsusage',   4,   0,  'G'],
      ...
      #   s -- size range, range of 1 or 2 sizes in unit of MByte
